...
namespace Child_Learn
{
    public partial class taa : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            player.SoundLocation = Environment.CurrentDirectory + @"\sound\tem.wav";
            player.Play(); 
        }
        ...
        private void bunifuCheckbox1_OnChange(object sender, EventArgs e)
        {
            ...
            {
                player.SoundLocation = Environment.CurrentDirectory + @"\sound\taa.wav";
                player.Play(); 
            }
            else
            {
        ...
        private void bunifuImageButton1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(" (^____^)  اكتب حرف التــاء اولا للأنتـــقال الي الدرس التالي", "خطــأ", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else if(f_letter.Text != "ب")
            {
                MessageBox.Show(" (^____^)  اكتب حرف التــاء صحيــح مثل (ت) للأنتـــقال الي الدرس التالي", "خطــأ", MessageBoxButtons.OK, MessageBoxIcon.Error);
